...
const items = [
  { icon: "/assets/images/selfservice.png", title: "Premium CPMs", desc: "Vignette banners command higher CPMs due to full-screen visibility and premium placement." },
  { icon: "/assets/images/traffic.png", title: "Brand-Safe Placement", desc: "Ads appear only at controlled, user-friendly transition points." },
  { icon: "/assets/images/rtb.png", title: "No Layout Disruption", desc: "No changes required to existing page layouts or content structures." },
  { icon: "/assets/images/api.png", title: "Optimized for Engagement", desc: "High visibility leads to stronger recall, interaction, and downstream performance. " },
...
export default function BenefitsVignette() {
  return (
    <div
      className="bv-container w-full min-h-screen pt-6 sm:pt-8 md:pt-10 lg:pt-12 pb-12 sm:pb-16 md:pb-18 lg:pb-20 relative mx-auto flex flex-col items-center justify-center gap-12 sm:gap-14 md:gap-16 lg:gap-[72px] overflow-hidden px-4 sm:px-6 lg:px-8 font-[Outfit]"
    >
      <section
        className="bv-section flex flex-col justify-center items-center w-full max-w-7xl"
      >
        <h2
          className="bv-title text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight font-bold text-[#1B1A1A] mb-10 sm:mb-12 md:mb-14 lg:mb-16 max-w-5xl px-4 sm:px-6"
        >
