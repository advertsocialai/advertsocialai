...
const FeaturesPushAds = () => {
  return (
    ...
    w-full max-w-full lg:w-[916px]"
      >
        <h2
          className="features-header-title text-[26px] sm:text-[32px] lg:text-[48px]"
        >
          Why are <span className="font-bold">Push Ads so effective?</span>
        </h2>

        <p
          className="features-header-subtitle text-[14px] sm:text-[16px] lg:text-[18px] leading-[22px] sm:leading-[26px] lg:leading-[28px]"
        >
          Permission-Based. High CTR. Always Visible.
        </p>

        <p
          className="features-header-desc text-[14px] sm:text-[16px] lg:text-[18px] leading-[22px] sm:leading-[26px] lg:leading-[28px]"
        >
          Push Ads are delivered to users who have explicitly opted in to receive
      ...
      >
        ...
        <div
          className="feature-grid-row-1 flex justify-between"
        >
        ...
        <div
          className="feature-grid-row-2 flex mx-auto"
        >
