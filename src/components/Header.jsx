...
export default function Header({ setIsVerticalsOpen }) {
  ...
  function VerticalsTabs({ onItemClick }) {
    const verticals = [
      {
        title: "Popunder",
        desc: "High-volume traffic source with maximum reach.",
        path: "/popunderads",
      },
      ...
      {
        title: "Interstitial",
        desc: "High-impact ads between content transitions.",
        path: "/interstitial",
      },
      {
        title: "Smartlink",
        desc: "Auto-optimized traffic routing for best ROI.",
        path: "/smartlink",
      },
    ];
    ...
    return (
      <div
        className="verticals-list grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8"
      ...
      >
        {verticals.map((item, index) => (
          ...
          >
            <h4 className="vertical-item-title font-semibold text-white text-sm">{item.title}</h4>
  ...
  return (
    <>
      ...
      >
        <div
          className="header-container flex items-center justify-between px-4 py-4 sm:px-6 md:px-8 lg:px-16 lg:py-6"
          style={{ minHeight: "60px", justifyContent: "space-between" }}
        >
          <a
            href="/"
            className="header-logo flex items-center w-40 h-10 sm:w-44 sm:h-12 md:w-48 md:h-14 lg:w-[220px] lg:h-[60px]"
          >
            <img
          ...
          <div className="hidden lg:flex items-center justify-between gap-4 xl:gap-8">
            <nav className="flex items-center justify-center gap-4 xl:gap-8">
              <button
                ...
                style={{ width: "104px", height: "34px", padding: "12px" }}
              >
                <span
                  className="nav-text"
                  style={{ width: "80px", fontSize: "1.1rem", fontFamily: "Outfit" }}
                >
                  Advertisers
                </span>
              </button>
              ...
              <button
                ...
                className="nav-btn"
                style={{ width: "72px", height: "26px", paddingTop: "8px", paddingBottom: "8px" }}
              >
                <span
                  className="nav-text"
                  style={{ width: "72px", fontSize: "1.1rem", fontFamily: "Outfit" }}
                >
                  Publishers
                </span>
              </button>
              ...
              >
                ...
                >
                  <span className="nav-text" style={{ fontSize: "1.1rem", fontFamily: "Outfit" }}>
                    Verticals
                  </span>
                  <img
              ...
              <button
                ...
                className="nav-btn cursor-pointer"
                style={{ width: "30px", height: "26px", paddingTop: "8px", paddingBottom: "8px" }}
              >
                <span
                  className="nav-text"
                  style={{ width: "30px", fontSize: "1.1rem", fontFamily: "Outfit" }}
                >
                  Blog
                </span>
              </button>
              ...
              <button
                ...
                className="nav-btn"
                style={{ width: "48px", height: "26px", paddingTop: "8px", paddingBottom: "8px" }}
              >
                <span
                  className="nav-text"
                  style={{ width: "48px", fontSize: "1.1rem", fontFamily: "Outfit" }}
                >
                  FAQ
                </span>
              </button>
              ...
              <button
                ...
                className="nav-btn"
                style={{ width: "67px", height: "26px", paddingTop: "8px", paddingBottom: "8px" }}
              >
                <span
                  className="nav-text"
                  style={{ width: "67px", fontSize: "1.1rem", fontFamily: "Outfit" }}
                >
                  Company
                </span>
              </button>
          ...
          {/* MOBILE MENU BUTTON */}
          <button
            className="lg:hidden p-2 ml-2 text-xl sm:text-2xl"
            ...
            <div className="absolute top-full left-0 right-0 bg-white shadow-lg lg:hidden z-50">
              <div className="flex flex-col p-4 sm:p-6">
                <button
                  ...
                  className="py-3 sm:py-4 text-sm sm:text-base font-semibold text-[#222222] hover:text-[#6549f6] text-left font-Outfit"
                >
                  Advertisers
                </button>
                <hr />
                ...
                <button
                  onClick={() => {
                    setShowVerticals((prev) => {
                      const next = !prev;
                      setIsVerticalsOpen(next);
                      return next;
                    });
                  }}
                  className="py-3 sm:py-4 text-sm sm:text-base font-semibold text-[#222222] hover:text-[#6549f6] text-left font-Outfit"
                ...
                <button
                  ...
                  className="mt-4 px-6 py-3 sm:px-7 rounded-[40px] bg-[#6A0DAD] text-white text-sm sm:text-base font-bold text-center hover:bg-[#333333] font-Outfit"
                >
                  Get Started
                </button>
              </div>
      ...
      {showRegister && (
        <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 1040 }}>
          ...
          />
          <div
            className="relative w-[90vw] max-w-[720px] flex justify-center"
            style={{ zIndex: 1050 }}
          >
