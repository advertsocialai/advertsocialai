    ...
    <section className="fv-section relative w-full bg-white overflow-hidden py-10 sm:py-16 md:py-20 lg:py-20 pb-6 sm:pb-8 md:pb-10 lg:pb-12 font-[Outfit]">
      ...
      <div className="fv-header-block flex flex-col items-center text-center gap-6 sm:gap-8 lg:gap-10 max-w-[90%] sm:max-w-[600px] lg:max-w-[916px] mx-auto mb-12 sm:mb-16 lg:mb-20 px-4">
        <h2 className="fv-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-[#1B1A1A] font-Outfit">
          Why are <span className="font-bold">Vignette Banner Ads so effective?</span>
        </h2>
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 md:hidden">
            <FeatureCardAnimated index={0}>
              <FeatureCardResponsive
                ...
                description="Full-screen, high-impact format"
              />
            </FeatureCardAnimated>
            ...
            <FeatureCardAnimated index={3}>
              <FeatureCardResponsive
                ...
                description="Exceptional viewability and attention
...
const FeatureCardResponsive = ({ image, title, description }) => {
  ...
  return (
    <div
      className="fv-card-responsive w-full max-w-sm mx-auto h-auto min-h-[300px] sm:min-h-[320px] rounded-2xl p-8 sm:p-10 lg:p-12 flex flex-col items-center text-center gap-6 sm:gap-8 bg-white transition-all duration-300 border border-[#EAEAEA] hover:border-transparent hover:-translate-y-1 hover:shadow-lg"
      style={{
        background: hover
    ...
    >
      <img src={image} alt={title} className="fv-card-icon-responsive w-10 h-10 sm:w-12 sm:h-12" />

      <div className="flex flex-col gap-4 sm:gap-6">
        <h3 className="fv-card-title-responsive text-lg sm:text-xl leading-tight text-[#1B1A1A] font-medium">
          {title}
        </h3>
        <p className="fv-card-desc-responsive text-sm sm:text-base leading-relaxed text-[#4B4B4B]">
          {description}
        </p>
      </div>
    </div>
...
export default FeaturesVignette;
