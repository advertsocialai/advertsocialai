...
import "./HeroInterstitial.css";

function HeroInterstitial() {
  ...
  return (
    <section
      id="advertisers"
      className="relative flex justify-center items-center w-full overflow-hidden mx-auto min-h-[520px] lg:min-h-0 hero-interstitial-section"
      style={{
        minHeight: "500px",
        height: "100vh",
        maxHeight: "720px",
    ...
    >
      <img
        ...
        alt="Hero Background"
        className="absolute bottom-0 left-0 w-full h-full object-cover hero-interstitial-bg"
        style={{
          borderRadius: "12px",
    ...
    ml-0
    lg:ml-[-40px]
    hero-interstitial-text-container
  "
          style={{
            width: "643px",
            height: "474px",
  ...
  "
          ...
          <motion.button
            variants={childVariants}
            className="mx-auto lg:mx-0 flex items-center justify-center hero-interstitial-btn"
            style={{
              width: "168px",
              height: "58px",
              gap: "8px",
        ...
        {/* RIGHT IMAGE */}
        <motion.img
          src="/assets/images/HeroInterstitial.png"
          alt="Interstitial Graphic"
          className="hidden lg:block hero-interstitial-right-image"
          style={{
            width: "500px",
            height: "500px",
            borderRadius: "67px",
      ...
      {/* BREADCRUMB */}
      <div className="absolute flex items-center bottom-2 left-4 sm:left-8 lg:left-[166px] gap-2 z-10 hero-interstitial-breadcrumbs">
        <span
...
export default HeroInterstitial;