...
import "../index.css";
import "./FeaturesAdvertisers.css";
...
const FeaturesAdvertisers = () => {
  return (
    ...
    w-full max-w-full lg:w-[916px] features-header-container"
        style={{
          width: "916px",
          gap: "40px",
        }}
      >
        <h2
          ...
          className="text-[26px] sm:text-[32px] lg:text-[48px] features-header-title"
        >
          Why are <span className="font-bold">Advertisers so effective?</span>
        </h2>

        <p
          className="text-[14px] sm:text-[16px] lg:text-[18px] leading-[22px] sm:leading-[26px] lg:leading-[28px] features-header-text-reg"
          style={{
            fontFamily: "Outfit",
            fontWeight: 700,
            // fontSize: "18px",
...
<style>
  {`
/* 
   Features Advertisers – Mobile Only
    */
...
/* ===== Mobile: Left align Feature cards ONLY ===== */
@media (max-width: 1024px) {
...
/* ===== FORCE mobile left alignment for feature cards ===== */
@media (max-width: 1024px) {
