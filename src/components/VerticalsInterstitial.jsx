...
const VerticalsInterstitial = () => {
  ...
  return (
    <section className="flex justify-center items-center w-full bg-white py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10 lg:pb-12">
      <div className="relative bg-black lg:bg-transparent w-full max-w-[1520px] min-h-[650px] sm:min-h-[700px] lg:h-[1097px] rounded-[24px] px-6 sm:px-12 lg:px-[80px] py-12 sm:py-16 lg:py-[100px] flex flex-col items-start lg:bg-[url('/assets/images/vertical-subtract.png')] lg:bg-contain lg:bg-center lg:bg-no-repeat">
        <div className="flex flex-col items-start gap-6 sm:gap-8 lg:gap-[40px] w-full max-w-4xl lg:max-w-[1014px] mb-12 sm:mb-16 lg:mb-[80px] lg:ml-[50px] text-left lg:text-left">
          <h2
            className="font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-tight text-white text-center lg:text-left
    ml-0 lg:ml-[-32px]"
          ...
          >
            ...
            Interstitial Traffic <br className="hidden sm:block" />
          </h2>
  ...
  `}
      ...
      >
        ...
        {Array.isArray(description) ? (
          <div style={{ width: "286px" }}>
            {description.map((line, idx) => (
              <div
                ...
                className="text-[16px] leading-[24px] w-[286px]"
              >
                {line}
              </div>
            ))}
          ...
          <p
            className="text-sm sm:text-base lg:text-[16px] leading-relaxed transition-colors duration-200"
            style={{ fontFamily: "Outfit" }}
          >
            {description}
          </p>
      ...
      <div className="absolute top-3 sm:top-6 lg:top-[66px] left-6 sm:left-8 md:left-12 lg:left-[66px] w-12 h-12 sm:w-14 sm:h-14 lg:w-[66px] lg:h-[66px] z-10">
        <img
          src={image}
          alt="icon"
...
export default VerticalsInterstitial;
