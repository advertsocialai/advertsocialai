...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-content-wrapper relative z-10 flex flex-col lg:flex-row justify-between items-center w-full px-4 sm:px-6 md:px-8 lg:px-[5%] max-w-[1280px] gap-8 lg:gap-0">
        <motion.div
        ...
        >
          ...
          >
            CPM and CPA campaigns for Popunder ads with ever-growing ROI. 35K+ high-quality Popunder
            traffic sources.
          </motion.p>
      ...
      <div className="hero-breadcrumbs absolute flex items-center bottom-2 left-4 sm:left-8 lg:left-[166px] gap-2 z-10">
        <span
