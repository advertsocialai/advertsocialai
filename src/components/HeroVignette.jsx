...
function HeroVignette() {
  ...
  return (
    <section
      id="advertisers"
      className="hv-section relative flex justify-center items-center w-full overflow-hidden mx-auto min-h-[520px] lg:min-h-0"
      style={{
        minHeight: "500px",
        height: "100vh",
        maxHeight: "720px",
    ...
    >
      <img
        ...
        alt="Hero Background"
        className="hv-bg-img absolute bottom-0 left-0 w-full h-full object-cover sm:object-contain"
        style={{
          borderRadius: "12px",
  ...
  "
          ...
          <motion.button
            variants={childVariants}
            className="hv-button mx-auto lg:mx-0 flex items-center justify-center"
            style={{
              width: "168px",
              height: "58px",
              gap: "8px",
        ...
        <motion.img
          ...
          alt="Vignette Banner Ads Graphic"
          className="hv-right-img hidden lg:block"
          style={{
            width: "500px",
            height: "500px",
            borderRadius: "67px",
      ...
      {/* BREADCRUMB */}
      <div className="hv-breadcrumb absolute flex items-center bottom-2 left-4 sm:left-8 lg:left-[166px] gap-2 z-10">
        <span
          className="hv-breadcrumb-item text-xs sm:text-sm cursor-pointer"
          style={{ fontFamily: "Outfit", color: "#222222" }}
          onClick={() => navigate("/")}
        >
          Home
        </span>
        <img src="/assets/images/side-arrow.png" className="hv-breadcrumb-arrow w-1 h-2" />
        <span
          className="hv-breadcrumb-item text-xs sm:text-sm"
