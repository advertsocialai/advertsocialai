...
export default function HeroContact() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-contact-content relative z-10 flex flex-col lg:flex-row justify-between lg:justify-center items-center w-full px-4 sm:px-6 md:px-8 lg:px-[5%] max-w-[1280px] gap-8 lg:gap-0 pt-20 pb-20 lg:py-0">
        <motion.div
        ...
        >
          ...
          >
            Our expertise and authenticity are remarkable and always strive to beat and outperform
            to build a safe and beneficial AI systems while observing how we help others!!
          </motion.p>
      ...
      >
        <span className="text-xs sm:text-sm" style={{ fontFamily: "Outfit", color: "#222222" }}>
          <a
            href="/"
            style={{ textDecoration: "none", color: "#222222", fontFamily: "Outfit" }}
        ...
        <img src="/assets/images/side-arrow.png" alt="side arrow" className="w-1 h-2" />
      ...
      {/* Mobile Breadcrumbs */}
      <div className="absolute lg:hidden flex items-center justify-center gap-2 z-10 bottom-4 left-0 right-0 order-3">
