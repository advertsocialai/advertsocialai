    ...
    return (
        <section className="flex justify-center items-center w-full bg-white py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10 lg:pb-12 verticals-advertisers-section">
            ...
            >
                ...
                >
                    <h2 className="font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-tight text-white verticals-title" style={{ fontFamily: 'Outfit' }}>
                ...
                >
                    ...
                    >
                        ...
                        <motion.div variants={cardVariants} className="w-full">
                            <a href="/verticalsad" style={{ display: 'block', width: '100%', fontFamily: 'Outfit' }}>
                                <VerticalCard
