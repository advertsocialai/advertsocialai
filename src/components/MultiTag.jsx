          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 400, color: "#FFFFFF" }}>to</span>
              </span>
              <span
                style={{
                  fontFamily: "Outfit",
            ...
            >
              ...
              >
                that leverages ad formats to help you monetize every aspect of your ad inventory,
                automates ad selection, and boosts CPM rates.
              </span>
            </p>
          </div>
            ...
            >
              <div className="flex-1 rounded-[20px] p-[24px] text-center max-lg:w-full max-md:p-[18px]">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div
                      style={{
                        ...
                        borderImage:
                          "repeating-linear-gradient(90deg, #fff 0 6px, transparent 6px 12px) 1",
                        borderLeft: "none",
                        borderRight: "none",
                        borderBottom: "none",
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ fontWeight: 400 }}>selects the most suitable</span>
                      </span>
                      <span
                        style={{
                          fontFamily: "Outfit",
               ...
               text-black font-bold text-[25px]"
                        ...
                        <div
                          className="multitag-row multitag-tag-row-upper"
                          style={{
                            display: "flex",
                            gap: "32px",
                            justifyContent: "center",
                        ...
                        <div
                          className="multitag-tag-row-lower"
                          style={{
                            display: "flex",
                            flexDirection: "row",
                            gap: "32px",
                        ...
                        <div className="absolute -bottom-[32px] left-1/2 -translate-x-1/2 z-20">
                          ...
                          >
                            <span>
                              <span style={{ fontWeight: 600 }}>High Ad Relevance</span>{" "}
                              <span style={{ fontWeight: 400 }}>leads</span>
                            </span>
                            <span style={{ fontWeight: 400 }}>to increased CPM rates</span>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderStyle: "solid",
                    borderImage:
                      "radial-gradient(78.99% 95.57% at 17.38% 2.08%, rgba(255, 255, 255, 0.22) 0%, rgba(15, 17, 19, 0.13) 100%) 1",
                ...
                >
                  ...
                  <p
                    className="text-[20px] max-md:text-[18px] max-sm:text-[16px]"
                    style={{ fontFamily: "Outfit" }}
                  >
                    The most advanced{" "}
          ...
          <div className="flex flex-col items-center gap-6 mt-16">
            ...
            <div className="text-center px-4 mb-8">
              <h2 className="text-[32px] leading-tight font-semibold">
                <span className="text-[#00E676] block">MultiTag – Your master key</span>
              ...
              <p className="mt-4 text-[14px] leading-[22px] text-[#f5f5f5]">
                <span className="text-[#00E676] font-semibold">An AI-based technology</span> that
                leverages ad formats to help you monetize every aspect of your ad inventory,
                automates ad selection, and boosts CPM rates.
              </p>
            </div>
            ...
            <div className="w-[90%] max-w-[360px] bg-white text-black rounded-lg p-4 text-center">
              <b>The Smart Auto-Optimization Algorithm</b>
              <br />
