...
const items = [
  {
    ...
    desc: "Traffic is routed to the offer with the highest probability of conversion.",
  },
  {
    icon: "/assets/images/traffic.png",
    title: "Full Traffic Monetization",
    desc: "Even low-intent or mixed traffic is intelligently monetized.",
  },
  {
    icon: "/assets/images/rtb.png",
    title: "Real-Time Optimization",
    desc: "Routing decisions are continuously optimized based on live performance data.",
  },
  {
    icon: "/assets/images/api.png",
    title: "Simple Setup, Scalable Results",
    desc: "Use a single link instead of managing multiple campaigns.",
  },
  {
