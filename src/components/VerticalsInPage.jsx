...
const VerticalsInPage = () => {
  ...
  return (
    <section className="vip-section flex justify-center items-center w-full bg-white py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10 lg:pb-12">
      <div className="vip-wrapper relative bg-black lg:bg-transparent w-full max-w-[1520px] min-h-[650px] sm:min-h-[700px] lg:h-[1097px] rounded-[24px] px-6 sm:px-12 lg:px-[80px] py-12 sm:py-16 lg:py-[100px] flex flex-col items-start lg:bg-[url('/assets/images/vertical-subtract.png')] lg:bg-contain lg:bg-center lg:bg-no-repeat">
        <div className="vip-header flex flex-col items-start gap-6 sm:gap-8 lg:gap-[40px] w-full max-w-4xl lg:max-w-[1014px] mb-12 sm:mb-16 lg:mb-[80px] lg:ml-[50px] text-left lg:text-left">
          <h2
            className="vip-title font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-tight text-white text-center lg:text-left
    ml-0 lg:ml-[-32px]"
          ...
          >
            ...
            In-Page Push Traffic <br className="hidden sm:block" />
          </h2>
          ...
          <div className="vip-button-wrapper w-full flex justify-start">
            <button className="vip-button flex items-center gap-2 sm:gap-[8px] bg-gradient-to-r from-[#00E676] to-[#6A0DAD] rounded-full px-6 sm:px-8 py-3 sm:py-4 w-fit hover:opacity-90 transition lg:ml-[-32px]">
              <span
                className="vip-button-text text-xs sm:text-sm font-bold text-white leading-4"
                style={{ fontFamily: "Outfit" }}
              >
                Explore All Cases
              </span>
  ...
  "
        ...
        <div className="vip-footer-row relative w-full flex justify-center lg:justify-start mt-6 sm:mt-8 lg:mt-[60px] lg:ml-[40px] z-20">
          <div className="vip-footer-box relative bg-black lg:bg-transparent px-4 py-2 sm:px-6 sm:py-3 lg:px-0 lg:py-0 rounded-lg lg:rounded-none">
            <p
              className="vip-footer-text text-lg sm:text-xl lg:text-2xl xl:text-3xl leading-tight font-semibold text-[#00E676] text-center lg:text-left"
              style={{ fontFamily: "Outfit" }}
            >
              Interstitial formats excel{" "}
              <span
                className="vip-footer-text-white text-white font-normal"
                style={{ fontFamily: "Outfit" }}
              >
...
"
  ...
  `}
      ...
      >
        <h3
          className="vip-card-title text-base sm:text-lg lg:text-[20px] leading-tight font-medium text-[#222222] group-hover:text-white"
          style={{ fontFamily: "Outfit" }}
        >
          {title}
        </h3>
        {Array.isArray(description) ? (
          ...
          <p
            className="vip-card-desc-item text-sm sm:text-base lg:text-[16px] leading-relaxed transition-colors duration-200"
            style={{ fontFamily: "Outfit" }}
          >
            {description}
          </p>
