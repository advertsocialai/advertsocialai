    ...
    return (
        <section className="flex justify-center items-center w-full bg-white py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10 lg:pb-12">
            ...
            >
                ...
                <div
                    className="flex flex-col gap-[32px] items-start justify-start"
                    style={{
                        width: "1014px",
                        marginTop: "32px",
                        marginLeft: "20px",
                ...
                >
                    <h2 className="font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-tight text-white" style={{ fontFamily: 'Outfit' }}>
                        <span className="text-[#00E676]" style={{ fontFamily: 'Outfit' }}>Top verticals</span> that thrive on{" "}
                        <br className="hidden sm:block" />
                        Publishers
                    </h2>

                    <button className="flex items-center gap-2 sm:gap-[8px] bg-gradient-to-r from-[#00E676] to-[#6A0DAD] rounded-full px-6 sm:px-8 py-3 sm:py-4 w-fit hover:opacity-90 transition mx-auto lg:mx-0">
                ...
                >
                    <div
                        className="flex flex-col sm:grid sm:grid-cols-2 lg:flex lg:flex-row gap-6 sm:gap-8 lg:gap-[40px] justify-center items-center"
                        style={{
                            width: "1280px",
                            marginTop: "60px",
                        }}
                ...
                <div className="relative w-full flex justify-center lg:justify-start mt-6 sm:mt-8 lg:mt-[60px] lg:ml-[40px] z-20">
                    <div className="relative bg-black lg:bg-transparent px-4 py-2 sm:px-6 sm:py-3 lg:px-0 lg:py-0 rounded-lg lg:rounded-none">
                        <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl leading-tight font-semibold text-[#00E676] text-center lg:text-left" style={{ fontFamily: 'Outfit' }}>
                            Publishing is especially effective for {" "}
...
const VerticalCard = ({ image, title, description, bestFor }) => {
 ...
 overflow-hidden rounded-[16px]"
        ...
        >
            ...
            <div
                className="absolute z-20 vertical-card-icon"
                style={{
                    top: "66px",
                    left: "46px",
                    width: "66px",
            ...
            <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-[16px] max-md:mask-none max-md:[-webkit-mask:none]"
                style={{
            ...
            <div
                className="absolute z-10 flex flex-col vertical-card-content"
                style={{
                    bottom: "40px",
                    left: "40px",
                    width: "286px",
...
export default VerticalsPublishers;
