...
const HowItWorksVignette = () => {
  return (
    <section
      className="hiwv-section relative w-full flex justify-center pt-6 sm:pt-8 md:pt-10 lg:pt-16 pb-12 sm:pb-16 md:pb-20 lg:pb-[20px] overflow-visible bg-white"
    ...
    >
      ...
      >
        ...
        <div className="block lg:hidden absolute inset-0 flex flex-col items-start justify-center gap-6 sm:gap-8 pt-36 sm:pt-44 md:pt-48 pb-12 px-2 sm:px-4 ml-2 sm:ml-4">
          ...
          <motion.div
            className="hiwv-mobile-text-block w-full max-w-lg flex-shrink-0 text-center"
            variants={childVariants}
          >
            <motion.p
              className="hiwv-mobile-desc text-sm sm:text-base leading-relaxed text-[#333] mb-4"
              style={{ fontFamily: "Outfit" }}
              variants={childVariants}
            >
        ...
        <div className="hidden lg:block">
          ...
          >
            <motion.p
              className="hiwv-desc text-[16px] leading-[28px] text-[#333] mb-[16px]"
              style={{ fontFamily: "Outfit" }}
              variants={childVariants}
            >
