    ...
    <section className="relative w-full bg-white overflow-hidden py-10 sm:py-16 md:py-20 lg:py-20 pb-6 sm:pb-8 md:pb-10 lg:pb-12 font-[Outfit]">
      ...
      <div className="flex flex-col items-center text-center gap-6 sm:gap-8 lg:gap-10 max-w-[90%] sm:max-w-[600px] lg:max-w-[916px] mx-auto mb-12 sm:mb-16 lg:mb-20 px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-[#1B1A1A] font-Outfit">
          Why are <span className="font-bold"> Smart Links so effective?</span>
        </h2>

        <p className="text-sm sm:text-base lg:text-lg leading-relaxed text-[#4B4B4B]  font-Outfit">
          Interstitial ads occupy the entire screen for a short duration, capturing user focus
          during moments when attention is naturally available.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 md:hidden">
            <FeatureCardAnimated index={0}>
              <FeatureCardResponsive
                ...
                description="Dynamic offer routing per click
No manual campaign switching"
              />
            </FeatureCardAnimated>
            ...
            <FeatureCardAnimated index={2}>
              <FeatureCardResponsive
                ...
                description="Maximizes EPC and conversion rates
Ideal for mixed or remnant traffic"
              />
            </FeatureCardAnimated>
            ...
            <FeatureCardAnimated index={3}>
              <FeatureCardResponsive
                ...
                description="IWorks across all devices and geographies
Smart Links turn every click into an opportunity.."
              />
            </FeatureCardAnimated>
          </div>
...
Smart Links turn every click into an opportunity.."
          ...
          <div
            className="hidden lg:block relative max-w-[1280px] mx-auto"
            style={{ height: "445px" }}
          >
            <div
...
Ideal for mixed or remnant traffic"
              ...
              <FeatureCardAnimated index={3}>
                <FeatureCard
                  image="/assets/images/impression.png"
                  title="Get Paid For Every Impression"
                  description="I Works across all devices and geographies
Smart Links turn every click into an opportunity.."
                  height="379px"
                  textGap="60px"
                />
...
export default FeaturesSmartLink;
