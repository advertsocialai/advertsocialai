...
function HeroInPage() {
  ...
  "
                    ...
                    >
                        ...
                        Advert Social AI’s In-Page Push Ads combine the high engagement of push notifications with the
                        flexibility of native display. These ads appear directly within website content, requiring no user opt-
                        in, making them ideal for scalable, compliant, and high-CTR campaigns.          </motion.p>
                    ...
                    >
                        <span
                            className="hip-button-text text-sm font-bold"
                        ...
                        <img
                            ...
                            alt="Arrow"
                            className="hip-button-icon w-3 h-3"
                        />
                    </motion.button>
                </motion.div>
