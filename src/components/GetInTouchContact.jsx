...
export default function GetInTouch() {
  ...
  return (
    <div
      className="get-in-touch-wrapper flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-[20px] mx-auto max-sm:items-start"
      style={{ maxWidth: "2700px" }}
    >
      <section
        id="contact"
        ...
        >
          ...
          <div className="flex flex-col justify-between w-full xl:w-auto xl:max-w-[550px] text-center xl:text-left gap-8 sm:gap-10 lg:gap-12 max-sm:text-left max-sm:items-start high-res-left">
            <div className="flex flex-col gap-6 sm:gap-7 md:gap-8 lg:gap-[40px] max-sm:items-start">
              ...
              <div
                className="flex flex-col max-sm:items-start max-sm:w-full max-sm:gap-6 high-res-info-grid"
                style={{ width: "100%", gap: "48px" }}
              >
                <div
                  className="flex max-sm:flex-col max-sm:items-start max-sm:w-full max-sm:gap-4"
                  style={{ width: "100%", gap: "48px" }}
                >
                  <div
                    className="flex flex-col max-sm:text-left max-sm:items-start max-sm:w-full max-sm:gap-2 contact-info"
                  ...
                  >
                    <h3
                      ...
                      className="high-res-subheading"
                    >
                      Contact Info
                    </h3>
                    <a
                      href="mailto:info@advertsocial.ai"
                      style={{
                        fontFamily: "Outfit",
                        fontWeight: 400,
                        fontSize: "16px",
                  ...
                  <div
                    className="flex flex-col max-sm:text-left max-sm:items-start max-sm:w-full max-sm:gap-2 address"
                    style={{ width: "100%", gap: "10px" }}
                  >
                    <h3
                      style={{
                ...
                >
                  <div
                    className="flex flex-col max-sm:text-left max-sm:items-start max-sm:w-full max-sm:gap-2 support-hours"
                    style={{ width: "100%", gap: "10px" }}
                  >
                    <h3
                      style={{
                  ...
                  <div
                    className="flex flex-col max-sm:text-left max-sm:items-start max-sm:w-full max-sm:gap-2 social-media-icons"
                    style={{ width: "100%", gap: "10px" }}
                  >
                    <h3
                      style={{
                    ...
                    <div
                      className="flex max-sm:justify-start max-sm:w-full max-sm:gap-2 high-res-socials"
                    ...
                    >
                      ...
                      >
                        <img
                          src="/assets/images/X (Twitter).png"
                          className="high-res-icon"
                          style={{ width: 44, height: 44 }}
                        />
                      </a>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 lg:p-12 xl:p-14 w-full xl:w-auto xl:max-w-[620px] high-res-form-card">
            <div className="flex flex-col gap-6">
              <h6
                className="text-xl sm:text-2xl font-medium high-res-form-title"
                style={{ fontFamily: "Outfit", color: "#1B1A1A" }}
              >
                Get in touch
              </h6>
              ...
              <p
                className="text-base sm:text-lg leading-relaxed high-res-form-desc"
              ...
              <form
                ...
                className="flex flex-col gap-4 sm:gap-6 mt-4 high-res-form"
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 high-res-grid">
                  <div className="flex flex-col w-full">
                    <label className="text-sm font-medium text-gray-700 mb-1 high-res-label">
                    ...
                    />
                    {errors.name && (
                      <span className="text-red-500 text-xs mt-1 high-res-error">
                        {errors.name}
                      </span>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 high-res-grid">
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div
                      className={`h-12 sm:h-14 rounded-xl bg-[#F6F6F6] px-4 sm:px-6 flex items-center border ${errors.phone ? "border-red-500" : "border-[#F6F6F6]"} hover:border-[#282828] focus-within:border-[#6549F6] high-res-input`}
                    >
                      <PhoneInput
                        international
                        defaultCountry="US"
                ...
                <div className="flex justify-start mt-2">
                  ...
                  >
                    ...
                    {!loading && (
                      <img src="/assets/images/arrow.png" alt="arrow-up" className="ml-2 w-3 h-3" />
                    )}
                  </button>
                </div>
              </form>
