...
const HowItWorksInterstitial = () => {
  return (
    <section className="relative w-full flex justify-center pt-6 sm:pt-8 md:pt-10 lg:pt-16 pb-12 sm:pb-16 md:pb-20 lg:pb-[20px] overflow-visible bg-white" style={{ fontFamily: 'Outfit' }}>
      ...
      >
        ...
        <motion.div
          className="absolute top-8 sm:top-12 lg:top-[67px] left-4 sm:left-8 lg:left-[182px] w-[90%] sm:w-[80%] lg:w-[916px] px-4 sm:px-0 z-10"
          variants={childVariants}
        >
          <h2
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[48px] font-bold text-[#1B1A1A] text-center lg:text-center leading-tight sm:leading-tight md:leading-tight xl:leading-[61px]"
        ...
        <div className="block lg:hidden absolute inset-0 flex flex-col items-start justify-center gap-6 sm:gap-8 pt-36 sm:pt-44 md:pt-48 pb-12 px-2 sm:px-4 ml-2 sm:ml-4">
          ...
          <motion.div className="w-full max-w-lg flex-shrink-0 text-center" variants={childVariants}>
            <motion.p className="text-sm sm:text-base leading-relaxed text-[#333] mb-4" style={{ fontFamily: 'Outfit' }} variants={childVariants}>
              Interstitial self-optimize continuously.
            </motion.p>
            ...
            <ul className="flex flex-col gap-4 sm:gap-5">
              {[
                "A user navigates between pages or app screens",
                "A full-screen Interstitial banner appears briefly",
                "The user engages or skips and continues their journey ",
              ].map((item, idx) => (
                <motion.li
                  key={idx}
        ...
        <div className="hidden lg:block">
          ...
          <motion.div
            ...
            variants={childVariants}
          >
            <motion.p className="text-[16px] leading-[28px] text-[#4B4B4B] mb-[16px]" style={{ fontFamily: 'Outfit' }} variants={childVariants}>
             Interstitial self-optimize continuously.
            </motion.p>
            ...
            <ul className="flex flex-col gap-[20px] mt-[40px]">
              {[
                ...
                >
                  ...
                  <span
                    className="font-normal text-[15px] text-[#282828] leading-[32px]"
                    style={{ fontFamily: 'Outfit' }}
                  >
                    {item}
                  </span>
...
export default HowItWorksInterstitial;
