...
export default function GetInTouch() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-[20px] mx-auto max-sm:items-start get-in-touch-root"
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col justify-between w-full xl:w-auto xl:max-w-[550px] text-center xl:text-left gap-8 sm:gap-10 lg:gap-12max-sm:text-left max-sm:items-start get-in-touch-features">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="flex max-sm:justify-start max-sm:w-full max-sm:gap-2"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          className="get-in-touch-social-icon"
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 lg:p-12 xl:p-14 w-full xl:w-auto xl:max-w-[620px] get-in-touch-form-container">
