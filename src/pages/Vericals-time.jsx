  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center w-full px-4 sm:px-6 md:px-8 lg:px-[5%] max-w-[1280px]">
        <motion.div
          className="hero-fp-text flex flex-col w-full px-4 text-center lg:text-left"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          >
            Advert Social AI guarantees NET-7 and NET-15 payment terms with multiple payout
            methods, real-time earnings tracking, and zero payment delays.
          </motion.p>
        ...
        <motion.img
          ...
          alt="On-time & Fast Payouts Graphic"
      ...
      <style>{`
        @media (max-width: 1023px) {
          .hero-fp-text { width: 100% !important; height: auto !important; margin-left: 0 !important; text-align: center !important; }
        }
      `}</style>
    </section>
  );
...
// ─── Features ──────────────────────────────────────────────────────────────────
const featureItems = [
  { image: "/assets/images/highcpm.png", title: "NET-7 & NET-15 Terms", description: "Choose your preferred payment cycle — weekly or bi-weekly — with guaranteed on-time disbursement." },
  { image: "/assets/images/impression.png", title: "Multiple Payout Methods", description: "Receive earnings via wire transfer, PayPal, cryptocurrency, Payoneer, and more payment options." },
  { image: "/assets/images/extraspace.png", title: "Real-Time Earnings Dashboard", description: "Track impressions, clicks, revenue, and payout status in real time with full transparency." },
  { image: "/assets/images/adblock.png", title: "No Hidden Fees", description: "Transparent revenue sharing with no surprise deductions, hidden charges, or unclear billing." },
];
    ...
    <section className="relative w-full bg-white overflow-hidden py-10 sm:py-16 lg:py-20 pb-6 sm:pb-8 lg:pb-12 font-[Outfit]">
      <div className="flex flex-col items-center text-center gap-6 sm:gap-8 lg:gap-10 max-w-[90%] sm:max-w-[600px] lg:max-w-[916px] mx-auto mb-12 sm:mb-16 lg:mb-20 px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-[#1B1A1A] font-[Outfit]">
          Why publishers choose <span className="font-bold">Fast & Reliable Payouts?</span>
        </h2>
        <p className="text-sm sm:text-base lg:text-lg leading-relaxed text-[#4B4B4B] font-[Outfit]">
          We believe publishers deserve to be paid on time, every time. Our streamlined payment
          infrastructure ensures your earnings are never delayed.
        </p>
      </div>
...
const howItWorksSteps = [
  "Earnings are tracked in real time across all your campaigns and placements",
  "Revenue is verified and consolidated at the end of each payment period",
  "Payments are automatically disbursed via your chosen method on schedule",
];
      ...
      >
        ...
        <motion.div className="absolute top-8 sm:top-12 lg:top-[67px] left-4 sm:left-8 lg:left-[182px] w-[90%] sm:w-[80%] lg:w-[916px] px-4 sm:px-0 z-10" variants={slideUp}>
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-[48px] font-bold text-[#1B1A1A] text-center leading-tight xl:leading-[61px]" style={{ fontFamily: "Outfit" }}>
            <span className="font-bold">How Fast Payout Processing Works</span>
            <br className="hidden sm:block" />
            <span className="font-normal">(Automated Payment Flow)</span>
          </h2>
        </motion.div>
        ...
        <div className="block lg:hidden absolute inset-0 flex flex-col items-start justify-center gap-6 sm:gap-8 pt-36 sm:pt-44 pb-12 px-2 sm:px-4 ml-2 sm:ml-4">
          <motion.div className="w-full max-w-sm sm:max-w-md flex-shrink-0" variants={slideUp}>
            <div className="relative w-full" style={{ aspectRatio: "447/385" }}>
              <img src="/assets/images/Play Reel.png" className="w-full h-full object-contain" alt="Payment Flow" />
          ...
          <motion.div className="w-full max-w-lg flex-shrink-0 text-center" variants={slideUp}>
            <p className="text-sm sm:text-base leading-relaxed text-[#333] mb-4" style={{ fontFamily: "Outfit" }}>
              Our automated payment system ensures you receive earnings without manual intervention.
            </p>
        ...
        <div className="hidden lg:block">
          <motion.div className="absolute" style={{ top: "237px", left: "109px", width: "447px", height: "385px" }} variants={slideUp}>
            <img src="/assets/images/Play Reel.png" className="w-full h-full" alt="Payment Flow" />
          ...
          <motion.div className="absolute" style={{ top: "246px", left: "674px", width: "496px", height: "auto" }} variants={slideUp}>
            <p className="text-[16px] leading-[28px] text-[#333] mb-[16px]" style={{ fontFamily: "Outfit" }}>
              Our automated payment system ensures you receive<br />earnings without manual intervention.
            </p>
...
// ─── Benefits ──────────────────────────────────────────────────────────────────
const benefitItems = [
  { icon: "/assets/images/selfservice.png", title: "Guaranteed On-Time Payment", desc: "NET-7 and NET-15 payment schedules are strictly honored — no delays, no excuses, every cycle." },
  { icon: "/assets/images/traffic.png", title: "Flexible Payout Thresholds", desc: "Set your preferred minimum payout threshold and receive payments automatically when reached." },
  { icon: "/assets/images/rtb.png", title: "Multiple Payment Methods", desc: "Wire transfer, PayPal, cryptocurrency, Payoneer, and WebMoney supported for global publishers." },
  { icon: "/assets/images/api.png", title: "Real-Time Revenue Tracking", desc: "Live dashboard shows earnings, impressions, eCPM, and payment status updated every hour." },
  { icon: "/assets/images/campaign.png", title: "Dedicated Finance Support", desc: "A dedicated finance team handles payment queries, invoice requests, and billing questions promptly." },
  { icon: "/assets/images/live.png", title: "Full Payment Transparency", desc: "Detailed payment statements, tax documentation, and complete audit trails available at all times." },
];
    ...
    <div className="w-full min-h-screen pt-6 sm:pt-8 lg:pt-12 pb-12 sm:pb-16 lg:pb-20 relative mx-auto flex flex-col items-center justify-center gap-12 sm:gap-14 lg:gap-[72px] overflow-hidden px-4 sm:px-6 lg:px-8 font-[Outfit]">
      <section className="flex flex-col justify-center items-center w-full max-w-7xl">
        <h2 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight font-bold text-[#1B1A1A] mb-10 sm:mb-12 lg:mb-16 max-w-5xl px-4 sm:px-6">
          Benefits of On-time & Fast Payouts
        </h2>
...
// ─── Page ──────────────────────────────────────────────────────────────────────
export default function Verticalstime() {
  return (
    <>
      <HeroSection />
      <FeaturesSection />
