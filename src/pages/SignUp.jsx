  ...
  return (
    <div className={`signup-page ${onClose ? "signup-modal-mode" : ""}`}>
      <div className="signup-wrapper">
        ...
        {onClose && (
          <button onClick={onClose} className="signup-close-btn" aria-label="Close">
            ✕
          </button>
        )}

        {/* Background Shape */}
        <img src="/assets/images/BG.svg" alt="Background" className="signup-bg" />
        ...
        <div className="signup-content-flow">
          ...
          <div className="signup-text-group">
            <h1 className="signup-title">Not sure where to start? Let’s talk</h1>
            <p className="signup-subtitle">
              Book a personalized walkthrough to see how advertsocial can help you find and win your
              best deals ever .
            </p>
          </div>
          ...
          <div className="email-section">
            ...
            <p className="signup-disclaimer">
              By Submitting this form, you will receive information, tips and Promotion from
              advertsocial. <br />
          ...
          {/* Action Button */}
          <button className="cta-button" onClick={handleSubmit} disabled={isSubmitting}>
            <span>{isSubmitting ? "Processing..." : "Book a Free Demo"}</span>
            {!isSubmitting && <img src="/assets/images/arrow-right.png" alt="Arrow Right" />}
          </button>
        </div>
      </div>
    </div>
