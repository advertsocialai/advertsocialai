                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="relative z-10 flex flex-col gap-6">
                        ...
                        <div className="flex justify-center mb-4">
                            <div className="w-24 h-24 rounded-full flex items-center justify-center border border-white/10"
                                ...
                                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
                                    ...
                                    <path d="M4 20c2.5-3.5 7-5 8-5s5.5 1.5 8 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold text-white/60 ml-4 uppercase tracking-wider">Email </label>
                            <input
                                name="email"
                                value={form.email}
                        ...
                        <div className="space-y-1.5 relative">
                            <label className="text-xs font-semibold text-white/60 ml-4 uppercase tracking-wider">Password</label>
                                ...
                                >
                                    {showPassword ? (
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M10.5 10.5a3 3 0 103 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M19.5 12a9 9 0 01-1.5 3M12 18a9 9 0 01-5-1.5M4.5 12a9 9 0 011.5-3M12 6a9 9 0 015 1.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    ) : (
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center justify-between text-[11px] text-white/40 mt-2 px-2">
                            <span className="font-semibold uppercase tracking-widest text-white/30">AdvertSocial</span>
                            <span>© 2026</span>
                        </div>
                    </form>
                </div>
